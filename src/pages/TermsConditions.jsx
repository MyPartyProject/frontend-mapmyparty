    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="max-w-5xl mx-auto px-8 py-12">
        ...
        <div className="space-y-8 text-muted-foreground leading-relaxed text-sm">
          ...
          {/* Section 3 */}
          <div className="pt-6 border-t border-border">
            <h2 className="text-lg font-semibold text-foreground mb-4">3. Commencement</h2>
          ...
          {/* Section 4 */}
          <div className="pt-6 border-t border-border">
            <h2 className="text-lg font-semibold text-foreground mb-4">4. Applicability & Modifications</h2>
          ...
          {/* Section 5 */}
          <div className="pt-6 border-t border-border">
            <h2 className="text-lg font-semibold text-foreground mb-4">5. Use of the Service</h2>
            
            <p className="mb-3 font-semibold text-foreground">5.1 General Use</p>
            ...
            <p className="mb-3 font-semibold text-foreground">5.2 Promoters</p>
            <ul className="list-disc list-inside space-y-1 ml-4 mb-4">
            ...
            <p className="mb-3 font-semibold text-foreground">5.3 Partners & Reps</p>
            <ul className="list-disc list-inside space-y-1 ml-4 mb-4">
            ...
            <p className="mb-3 font-semibold text-foreground">5.4 Resellers</p>
            <ul className="list-disc list-inside space-y-1 ml-4 mb-4">
            ...
            <p className="mb-3 font-semibold text-foreground">5.5 Customers</p>
          ...
          {/* Section 6 */}
          <div className="pt-6 border-t border-border">
            <h2 className="text-lg font-semibold text-foreground mb-4">6. Payments & Refunds</h2>
          ...
          {/* Section 7 */}
          <div className="pt-6 border-t border-border">
            <h2 className="text-lg font-semibold text-foreground mb-4">7. Platform Status</h2>
            <p>MapMyParty acts solely as a ticketing intermediary and does not host or produce Events.</p>
          </div>

          {/* Section 8 */}
          <div className="pt-6 border-t border-border">
            <h2 className="text-lg font-semibold text-foreground mb-4">8. Intellectual Property</h2>
          ...
          {/* Section 9 */}
          <div className="pt-6 border-t border-border">
            <h2 className="text-lg font-semibold text-foreground mb-4">9. User Representations</h2>
            <p>Users warrant lawful use, accuracy of information, and non-infringement of third-party rights.</p>
          </div>

          {/* Section 10 */}
          <div className="pt-6 border-t border-border">
            <h2 className="text-lg font-semibold text-foreground mb-4">10. Security, Bugs & Viruses</h2>
          ...
          {/* Section 11 */}
          <div className="pt-6 border-t border-border">
            <h2 className="text-lg font-semibold text-foreground mb-4">11. Data Protection & Privacy</h2>
            ...
            <p className="mb-3 font-semibold text-foreground">11.2A India-Specific Compliance</p>
          ...
          {/* Section 12 */}
          <div className="pt-6 border-t border-border">
            <h2 className="text-lg font-semibold text-foreground mb-4">12. Exclusion of Warranties & Limitation of Liability</h2>
            <ul className="list-disc list-inside space-y-1 ml-2">
          ...
          {/* Sections 13-22 */}
          <div className="pt-6 border-t border-border">
            <h2 className="text-lg font-semibold text-foreground mb-4">13. Indemnity</h2>
            <p>Users indemnify MapMyParty against claims arising from misuse, breach, or unlawful activity.</p>
          </div>

          <div className="pt-6 border-t border-border">
            <h2 className="text-lg font-semibold text-foreground mb-4">14. External Links</h2>
            <p>MapMyParty is not responsible for third-party websites or content.</p>
          </div>

          <div className="pt-6 border-t border-border">
            <h2 className="text-lg font-semibold text-foreground mb-4">15. Force Majeure</h2>
            <p>Performance delays due to events beyond reasonable control are excused.</p>
          </div>

          <div className="pt-6 border-t border-border">
            <h2 className="text-lg font-semibold text-foreground mb-4">16. Termination</h2>
            <p>Either party may terminate immediately. Certain obligations survive termination.</p>
          </div>

          <div className="pt-6 border-t border-border">
            <h2 className="text-lg font-semibold text-foreground mb-4">17. Waiver</h2>
            <p>Failure to enforce rights does not constitute waiver.</p>
          </div>

          <div className="pt-6 border-t border-border">
            <h2 className="text-lg font-semibold text-foreground mb-4">18. Assignment</h2>
            <p>Users may not assign rights without consent. MapMyParty may assign freely.</p>
          </div>

          <div className="pt-6 border-t border-border">
            <h2 className="text-lg font-semibold text-foreground mb-4">19. Notices</h2>
            <p>All notices shall be in writing and sent to MapMyParty at the registered address.</p>
          </div>

          <div className="pt-6 border-t border-border">
            <h2 className="text-lg font-semibold text-foreground mb-4">20. Severability</h2>
            <p>Invalid provisions do not affect remaining Terms.</p>
          </div>

          <div className="pt-6 border-t border-border">
            <h2 className="text-lg font-semibold text-foreground mb-4">21. Entire Agreement</h2>
            <p>These Terms constitute the entire agreement between the parties.</p>
          </div>

          <div className="pt-6 border-t border-border">
            <h2 className="text-lg font-semibold text-foreground mb-4">22. Governing Law & Jurisdiction</h2>
