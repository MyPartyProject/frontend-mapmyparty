        ...
        <div className="space-y-8 text-sm text-muted-foreground leading-relaxed">
          <section className="pt-6 border-t border-border">
            ...
            <ul className="list-disc list-inside space-y-2 ml-2">
              ...
              <li>Successful paid bookings are marked as <span className="text-foreground font-medium">REFUNDED</span> and corresponding refund records are created.</li>
            </ul>
          </section>

          <section className="pt-6 border-t border-border">
            <h2 className="text-lg font-semibold text-foreground mb-4">2. Organizer Refund Restrictions</h2>
            <ul className="list-disc list-inside space-y-2 ml-2">
          ...
          <section className="pt-6 border-t border-border">
            <h2 className="text-lg font-semibold text-foreground mb-4">3. Completed Event Restriction</h2>
            <ul className="list-disc list-inside space-y-2 ml-2">
          ...
          <section className="pt-6 border-t border-border">
            <h2 className="text-lg font-semibold text-foreground mb-4">4. Eligible Refund Conditions</h2>
            <ul className="list-disc list-inside space-y-2 ml-2">
          ...
          <section className="pt-6 border-t border-border">
            <h2 className="text-lg font-semibold text-foreground mb-4">5. Ticket Inventory Handling</h2>
            <ul className="list-disc list-inside space-y-2 ml-2">
          ...
          <section className="pt-6 border-t border-border">
            ...
            <ul className="grid gap-3 sm:grid-cols-2">
              {refundStatuses.map((status) => (
                <li
                  key={status}
                  className="rounded-xl border border-border bg-muted px-4 py-3 font-medium text-foreground"
                >
                  {status}
                </li>
              ))}
