      ...
      <div className="max-w-5xl mx-auto px-8 py-12">
        ...
        <div className="space-y-8 text-muted-foreground leading-relaxed text-sm">
          ...
          <p className="text-muted-foreground">
            ...
            <Link to="/privacy-policy" className="text-accent-foreground hover:underline">
              Privacy Policy
            </Link>.
          </p>
          ...
          {/* Section 2 */}
          <div className="pt-6 border-t border-border">
            <h2 className="text-lg font-semibold text-foreground mb-4">2. Why We Use Cookies</h2>
            ...
            <p className="text-sm text-muted-foreground italic mt-4">We do not use cookies to sell or trade your Personal Data.</p>
          </div>

          {/* Section 3 */}
          <div className="pt-6 border-t border-border">
            <h2 className="text-lg font-semibold text-foreground mb-4">3. Types of Cookies We Use</h2>
            
            <p className="mb-3 font-semibold text-foreground">a. Strictly Necessary Cookies</p>
            <p className="mb-2 text-sm text-muted-foreground">Cannot be disabled</p>
            ...
            <p className="text-sm text-muted-foreground mb-6">Legal basis: Legitimate interest / contractual necessity (GDPR Article 6(1)(b), 6(1)(f))</p>

            <p className="mb-3 font-semibold text-foreground">b. Performance & Analytics Cookies</p>
            <p className="mb-2 text-sm text-muted-foreground">Optional</p>
            ...
            <p className="text-sm text-muted-foreground mb-6">Analytics data is aggregated and anonymised wherever possible. Legal basis: Consent (GDPR Article 6(1)(a))</p>

            <p className="mb-3 font-semibold text-foreground">c. Functional Cookies</p>
            <p className="mb-2 text-sm text-muted-foreground">Optional</p>
            ...
            <p className="text-sm text-muted-foreground mb-6">Without these cookies, some features may not function properly. Legal basis: Consent (GDPR Article 6(1)(a))</p>

            <p className="mb-3 font-semibold text-foreground">d. Marketing & Communication Cookies (Optional)</p>
            <p className="mb-2 text-sm text-muted-foreground">Optional</p>
            ...
            <p className="text-sm text-muted-foreground">We do not use cookies for third-party behavioural advertising without your explicit consent. Legal basis: Explicit consent (GDPR Article 6(1)(a))</p>
          </div>

          {/* Section 4 */}
          <div className="pt-6 border-t border-border">
            <h2 className="text-lg font-semibold text-foreground mb-4">4. Third-Party Cookies</h2>
          ...
          {/* Section 5 */}
          <div className="pt-6 border-t border-border">
            <h2 className="text-lg font-semibold text-foreground mb-4">5. Cookie Consent</h2>
          ...
          {/* Section 6 */}
          <div className="pt-6 border-t border-border">
            <h2 className="text-lg font-semibold text-foreground mb-4">6. Managing Cookies</h2>
            <p className="mb-4">You can manage or delete cookies through:</p>
            <ul className="list-disc list-inside space-y-1 ml-2">
              <li>Your browser settings</li>
              <li>Our cookie preference centre (if enabled)</li>
            </ul>
            <p className="text-sm text-muted-foreground italic mt-4">Please note that disabling certain cookies may affect the functionality of the Platform.</p>
          </div>

          {/* Section 7 */}
          <div className="pt-6 border-t border-border">
            <h2 className="text-lg font-semibold text-foreground mb-4">7. How Long Cookies Are Stored</h2>
          ...
          {/* Section 8 */}
          <div className="pt-6 border-t border-border">
            <h2 className="text-lg font-semibold text-foreground mb-4">8. Updates to This Cookie Policy</h2>
          ...
          {/* Section 9 */}
          <div className="pt-6 border-t border-border">
            <h2 className="text-lg font-semibold text-foreground mb-4">9. Contact Us</h2>
