...
const Sidebar = React.forwardRef(function Sidebar({ side = "left", variant = "sidebar", collapsible = "offcanvas", className, children, ...props }, ref) {
...
const SidebarRail = React.forwardRef(function SidebarRail({ className, ...props }, ref) {
  const { toggleSidebar } = useSidebar();
...
const SidebarInset = React.forwardRef(function SidebarInset({ className, ...props }, ref) {
  return (
    <main
      ref={ref}
      className={cn(
...
const SidebarGroupLabel = React.forwardRef(function SidebarGroupLabel({ className, asChild = false, ...props }, ref) {
  ...
  return (
    <Comp
      ...
      className={cn(
        "flex h-8 shrink-0 items-center rounded-md px-2 font-heading text-xs font-medium leading-tight tracking-normal text-sidebar-foreground/70 outline-none ring-sidebar-ring transition-[margin,opa] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
...
const SidebarMenuSubButton = React.forwardRef(function SidebarMenuSubButton({ asChild = false, size = "md", isActive, className, ...props }, ref) {
